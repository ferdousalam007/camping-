    ...
    >
      <div>
        ...
        <div className="absolute right-[14px] bottom-[55px]">
          <div className="bg-[#ff8851] border-2 border-[#fff] p-3 rounded-full cursor-pointer">
            <svg
            ...
            <div>
              <div className="flex space-y-2 justify-center flex-col pt-3 bg-[#1b352c] py-4 px-2 rounded-full hover-team">
