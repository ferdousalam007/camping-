            ...
            >
              ...
              >
                ...
                <AccordionContent className="bg-gray-100 px-4 py-2 text-base">
                  ...
                  including tents, sleeping bags, cooking equipment, hiking
                  gear, and fun outdoor gadgets. Whether you're a beginner or a
                  seasoned camper, we have everything you need for your next
                  adventure.
                </AccordionContent>
              </AccordionItem>
              ...
              >
                ...
                <AccordionContent className="bg-gray-100 px-4 py-2 text-base">
                  Yes, we ship our products worldwide! Shipping costs and
                  delivery times vary depending on your location. You can check
                  the shipping options available for your country at checkout.
                </AccordionContent>
              </AccordionItem>
              ...
              >
                ...
                <AccordionContent className="bg-gray-100 px-4 py-2 text-base">
                  ...
                  made from eco-friendly materials, and we continuously work
                  with our suppliers to reduce our environmental impact. Look
                  for the "Eco-Friendly" label on our products.
                </AccordionContent>
              </AccordionItem>
              ...
              >
                ...
                <AccordionContent className="bg-gray-100 px-4 py-2 text-base">
                  Yes, we offer discounts on bulk purchases. If you're planning
                  a group trip or need a large quantity of items, please contact
                  our customer service team for more details on bulk pricing and
                  discounts.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
